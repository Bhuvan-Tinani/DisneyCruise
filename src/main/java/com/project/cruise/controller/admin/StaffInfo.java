...
public class StaffInfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StaffInfo</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StaffInfo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            IAdminRepo repo=new AdminRepo(con);
            ArrayList<Staff> staffList=repo.getAllStaff();
