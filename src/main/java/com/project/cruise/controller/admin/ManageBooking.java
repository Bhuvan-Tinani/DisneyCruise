...
public class ManageBooking extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<BookingDetails> passenger=repo.getAllBokingDetail();
            request.setAttribute("bookingDetails",passenger);
            request.getRequestDispatcher("jspPages/admin/manageBooking.jsp").forward(request, response);
