 ...
 * @author My PC
 */
public class ManagePassenger extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Passenger> passenger=repo.getAllPassenger();
            request.setAttribute("passenger",passenger);
            request.getRequestDispatcher("jspPages/admin/managePassenger.jsp").forward(request, response);
