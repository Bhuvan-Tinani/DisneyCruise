...
import com.project.cruise.model.repo.passenger.IPassengerRepo;
...
public class SignUp extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("jspPages/passenger/SignUp.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        SignUpInfo signUpInfo = new SignUpInfo(userName, password);
        ServletConfig scf = getServletConfig();
        ServletContext sc = scf.getServletContext();
        Connection con = (Connection) sc.getAttribute("connection");
        IPassengerRepo respo = new PassengerRepo(con);
        try {
            if (respo.createAccount(signUpInfo)) {
                ...
                out.println("<script>alert('data not registered')</script>");
            }
