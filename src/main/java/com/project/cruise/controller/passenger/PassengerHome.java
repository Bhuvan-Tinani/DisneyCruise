 ...
 * @author My PC
 */
public class PassengerHome extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isPassenger;
        try {
            isPassenger = repo.isPassenger(username);
            request.setAttribute("isPassenger", isPassenger);
            
            RequestDispatcher rd = request.getRequestDispatcher("jspPages/passenger/home.jsp");
            rd.forward(request, response);
        } catch (SQLException ex) {
            Logger.getLogger(PassengerHome.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
